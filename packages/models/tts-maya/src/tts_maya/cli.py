"""Human-friendly CLI for Maya/Veena TTS synthesis.

Usage:
    uv run --project packages/models/tts-maya python -m tts_maya.cli \
...
from tts_maya.synthesizer import LocalMayaSynthesizer
...
@click.option("--voice-id", default=None, help="Voice preset [default: kavya].")
...
def main(
    ...
    """Synthesize speech from text using Maya/Veena."""
    logger.remove()
    ...
    synthesizer = LocalMayaSynthesizer()
