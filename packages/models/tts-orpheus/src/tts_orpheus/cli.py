"""Human-friendly CLI for Orpheus TTS synthesis.

Usage:
    uv run --project packages/models/tts-orpheus python -m tts_orpheus.cli \
...
from tts_orpheus.synthesizer import LocalOrpheusSynthesizer
...
@click.option("--voice-id", default=None, help="Voice preset [default: tara].")
...
def main(
    ...
    synthesizer = LocalOrpheusSynthesizer()
